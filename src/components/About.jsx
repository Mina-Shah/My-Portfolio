    ...
    <div className="text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6">
          {[
            { src: "images/html.png", alt: "HTML Logo", name: "HTML" },
            { src: "images/css.png", alt: "CSS Logo", name: "CSS" },
            { src: "images/js.png", alt: "JavaScript Logo", name: "JavaScript" },
            { src: "images/tailwind.png", alt: "Tailwind CSS Logo", name: "Tailwind CSS" },
            { src: "images/vite.png", alt: "Vite Logo", name: "Vite" },
            { src: "images/webpack.png", alt: "Webpack Logo", name: "Webpack" },
            { src: "images/react.png", alt: "React Logo", name: "React" },
            { src: "images/git.png", alt: "Git Logo", name: "Git" },
            { src: "images/github.jpg", alt: "GitHub Logo", name: "GitHub" },
          ].map((tech) => (
            <div key={tech.name} className="flex flex-col items-center">
              <img
                src={tech.src}
                className="w-12 h-12 animate-pulse hover:animate-none"
                alt={tech.alt}
              />
